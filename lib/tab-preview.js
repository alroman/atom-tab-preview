  ...
  activate(state) {
    ...
    function observePane(pane){
      ...
      if(pane.onDidChange){
        ...
        let refreshPreviewLazy = function(){
        ...
        composite.add(pane.onDidChangeScrollTop(refreshPreviewLazy));
        composite.add(pane.onDidChange(refreshPreviewLazy));
